...
$conf['settings']['admin.email'] = 'zachary.peters@mining.komatsu';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://zackpeters.com/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'zackpete_me';        // database user with permission to the booked database
